...
const char* const KFieldAreaNameId = "area_nameid";
...
const char* const KFieldDbHistory = "dbhistory";
...
const char* const KFieldCountryNameId = "country_nameid";
...
const char* const KFieldFullInfo = "fullinfo";
...
const char* const KFieldEduNameId = "edu_nameid";
...
const char* const KFieldPersonStatusUid = "person_status_uid";
...
const char* const KFieldEventName = "event_name";
const char* const KFieldEventNameId = "event_nameid";
const char* const KFieldPersonEventUid = "person_event_uid";
const char* const KFieldPersonEventName = "person_event_name";
const char* const KFieldPersonEventNameId = "person_event_nameid";
const char* const KFieldSaintUid = "saint_uid";
const char* const KFieldSaintDbId = "saint_dbid";
const char* const KFieldSaintName = "saint_name";
const char* const KFieldSaintFullName = "saint_fullname";
...
const char* const KFieldPersonEmail = "person_email";
const char* const KFieldPersonTel = "person_tel";
...
const char* const KFieldCommunityNameId = "community_nameid";
...
const char* const KFieldSpecialistInfo = "specialist_info";
