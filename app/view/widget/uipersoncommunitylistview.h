 ...
 * Brief:
 */
#ifndef UIPERSONCOMMUNITYLISTVIEW_H
#define UIPERSONCOMMUNITYLISTVIEW_H
 ...
 */
class UIPersonCommunityListView : public UICommonListView
{
public:
    explicit UIPersonCommunityListView(QWidget *parent = nullptr);
    virtual ~UIPersonCommunityListView();
...
#endif // UIPERSONCOMMUNITYLISTVIEW_H
