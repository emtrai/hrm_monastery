...
#define STR_DS_NU_TU        QObject::tr("Danh sách Nữ tu")
...
#define STR_IMPORT_DATA             QObject::tr("Nhập dữ liệu")
...
#define STR_PERSON_MOVE_OUT_COMMUNITY   \
        QObject::tr("Thay đổi thông tin cộng đoàn - Nữ tu chuyển khỏi Cộng đoàn hiện tại")
#define STR_PERSON_MOVE_IN_COMMUNITY    \
        QObject::tr("Thay đổi thông tin cộng đoàn - Nữ tu chuyển đến Cộng đoàn %1")
...
#define STR_BACKUP_ERRCODE      QObject::tr("Sao lưu file thất bại, mã lỗi %1")
